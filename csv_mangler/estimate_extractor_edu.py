...
Now we're pulling education data, which is split by gender. In this version we pool
across MALE and FEMALE entries - in the version that was ultimately used
(estimate_extractor_edu_by_gender.py), MALE and FEMALE are kept split out. So this is
relevant mainly only for historical reasons.
"""
import os
import itertools
import lookup
    ...
    for line in f:
        ...
        if sequence == args.sequence and logrec in RELEVANT_LOCRECS:
            ...
            for n1,n2 in factors:
                ...
                idx += 1
                print '%s,%s,%s,%d,%s'%(args.rectype,location,n2,male_val+female_val,n1)
