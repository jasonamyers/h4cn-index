...
This is based on estimate_extractor_edu, and differs from that really only in that MALE
and FEMALE data are here kept separate, rather than pooled as in that script.
"""
import os
import itertools
import lookup
